...
# The Area Under a Curve
 ...
 - With derivatives, we approximated the hard thing (slope of a curve) using an easy thing (slope of a line) by zooming in close enough.
...
--
 ...
 - We'll approximate the hard thing (area under a curve) using an easy thing (area of a bunch of rectangles) by making the rectangles *really* small.
