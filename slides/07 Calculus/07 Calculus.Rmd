...
Suppose that happiness as a function of jellybeans consumed is 

$$h(j) = -\frac{1}{3}j^3 + 81j + 2$$ 

How many jellybeans should you eat? (Assume you can only eat a positive number of jellybeans).
