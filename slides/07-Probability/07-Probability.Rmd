...
<TODO: make that 10000>

```{r repeat mean sample ages histogram, out.width='50%'}
sampling_distribution <- replicate(1000, mean_age_of_sample(data = CCES, n = 100))
...
sampling_distribution <- replicate(1000, mean_age_of_sample(data = CCES, n = 400))
...
sampling_distribution <- replicate(1000, difference_in_means(CCES, n1 = 100, n2 = 100))
