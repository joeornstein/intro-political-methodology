...
(That weird trick is called **frequentist hypothesis testing**)

1. Define your Null Hypothesis $(H_0)$

2. Compute the distribution of the test statistic under $H_0$

3. Compute the test statistic from your dataset.

4. How unlikely is it?
...
Q <- replicate(10000, fraction_Q(1000))

tibble(Q) %>% 
  ggplot() +
  geom_histogram(aes(x=Q, y = ..density..), color = 'black', binwidth = 3) +
  labs(x = 'Fraction of Qs in a Random String of Size 1000',
       y = 'Probability') +
  theme_bw()
```