...
Because petal length tends to be larger than average whenever sepal length is larger than average, and vice versa, when you take the average of all the the $(X-\bar{X})(Y-\bar{Y})$, you will get a positive number.
...
Correlation coefficients are nice, but limited. <TODO: two slopes>

--

Want to find the **slope** of the relationship. 

  - When we increase $X$ by 1, how much does $Y$ increase or decrease, on average?
  
--

Would also like to perform hypothesis tests and compute confidence intervals.
...
We're going to find the slope that minimizes the **sum of squared errors**.
...
<TODO: beta hat = cov(x,y) / var(x)>

---

## What's the right slope?

Three Steps of Minimizing a Function?
