...
$$\begin{bmatrix} 4 \\ 6 \\ 10 \end{bmatrix} = 2 + 2 \times \begin{bmatrix} 1 \\ 3 \\ 4 \end{bmatrix} + \begin{bmatrix} 0 \\ -2 \\ 0 \end{bmatrix}$$
...
To see how we estimate the line of best fit, let's create some random data.
...
### How do we find a good slope estimate?
...
2. Generate Sampling Distribution of $\hat{b}$
...
```{r sampling function}
null_slope_estimate <- function(a = 0, b = 0, X,
                               sd_epsilon = 2){
