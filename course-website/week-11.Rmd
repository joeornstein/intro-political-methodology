...
[^8]: The sample mean is the sum of your all your sample values $(X)$ divided by the sample size $(n)$.
    ...
    One property of variance is that $\text{Var}(ax) = a^2\text{Var}(X)$ for any constant $a$. If $\text{Var}(X_i) = \sigma^2$, then:

    $$
    \text{Var}\left(\frac{\sum{X_i}}{n}\right) = \frac{1}{n^2} (n\sigma) = \frac{\sigma^2}{n}
    $$

    The square root of that variance, $\frac{\sigma}{\sqrt{n}}$, is the standard error of th mean.
