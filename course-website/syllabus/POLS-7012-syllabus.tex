...
\subsubsection*{Week 2: Summarizing Data}
\textit{Computing Descriptive Statistics, Comparing Groups}

\subsubsection*{Week 3: No Class (APSA)}
\textit{Take time to explore your own datasets and develop ieas for midterm projects}

\subsubsection*{Week 4: Visualizing Data}
\textit{ggplot2, Distributions, Correlations, Conditional Distributions}

\subsubsection*{Week 5: Tidying Data}
