...
1.  Download the [voting.csv](data/voting.csv) file and put it into your DSS folder. Read the dataset into R and save it as an object called `voting`. (10 points)
