...
| Alive w/ Hospital $(Y_0)$ | Alive w/o Hospital $(Y_1)$ | Hospital $(X)$ | Alive $(Y)$ |
|-------|-------|-----|-----|
| 0     | 1     | 1   | 1   |
| 1     | 1     | 0   | 1   |
| 0     | 0     | 1   | 0   |
...
We'd like to know $Y_1$ - $Y_0$, the treated outcome minus the untreated outcome. But we can't do that, because we only ever see one of the potential outcomes. The best we can do is estimate the **average treatment effect**.
