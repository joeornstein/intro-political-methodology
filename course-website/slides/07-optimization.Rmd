...
- **Fixed Effects / Random Effects** = The Linear Model + Categorical Predictor Variables

- **Difference-in-differences** = The Linear Model + Time

--

Statistical modeling can seem pretty daunting when you think about it as a bunch of tests with no obvious connections. Instead, let's build everything from the ground up...
