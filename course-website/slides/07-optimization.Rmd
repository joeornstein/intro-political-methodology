...
<!-- $f(x,y,b) = (y_1 - bx_1)^2 + (y_2 - bx_2)^2 + \ldots + (y_n - bx_n)^2$ -->

<!-- -- -->

<!-- $f(x,y,b) = (y_1^2 - 2bx_1y_1 + b^2x_1^2) + (y_2^2 - 2bx_2y_2 + b^2x_2^2) + \ldots + (y_n^2 - 2bx_ny_n + b^2x_n^2)$ -->

$f(x,y,b) = \sum (y - bx)^2$

--

$f(x,y,b) = \sum (y^2 + b^2x^2- 2bxy )$
...
$\frac{\partial f}{\partial b} = \sum (2bx^2 - 2xy)$
