...
```{r party-data, echo = FALSE, out.width='640px', out.height='400px'}
...
$$\underbrace{Y}_\text{outcome} = X\beta + \varepsilon$$
```{r}
p + geom_smooth(method = 'lm', se = FALSE)
```
...
1. To describe relationships in the data.
...
**Good news!** You're extremely close to knowing all the calculus you need.
...
<!-- Saving all the integral calculus for our week on probability distributions -->
...
<!-- Moving this to the integral calculus slides... -->
