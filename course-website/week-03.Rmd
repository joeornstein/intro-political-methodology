...
This week, we'll learn some of the most important functions in the `tidyverse` for data importing, wrangling, and summarizing. We'll introduce the essential **summary statistics** that we use to describe central tendency, variation, and correlation.
