...
1. How to  **join** information from two dataframes together. `left_join()` is the most useful. Here's a [good explanation](https://stat545.com/join-cheatsheet.html#left_joinsuperheroes-publishers), and here's an [interactive primer](https://rstudio.cloud/learn/primers/4.3).
