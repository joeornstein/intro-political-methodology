...
1.  Recreate the following chart using the [voting.csv](data/voting.csv) dataset. (25 points)
...
2.  Recreate the following chart using the [ANES.csv](data/ANES.csv) dataset. Don't forget the caption. (25 points) \
    Recreating the dashed vertical lines is worth a **bonus** 10 points.
