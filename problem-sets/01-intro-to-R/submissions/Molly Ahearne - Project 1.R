...
nrow(data)
#How many observations are in this data set? Answer: 3165
...
names(data)
#What are the names of these variables? Answer:
[1] "version"                     
[2] "caseid"                      
[3] "weight"                      
[4] "weight_spss"                 
...
median(age)
#What is the median age of survey respondents? Answer: 56
...
#get the vote16 variable, only the entries where it equals -1, and assign those entires value NA
data$vote16[data$vote16 == -1] <- NA

#create a table of variable vote16 - with updated value of NA
table(data$vote16)
#What happened? Answer: The -1 column no longer exists in the table.

#create a table of variable liveurban
table(data$liveurban)
#Where are respondents most likely to live? Answer: Suburb
...
#create a table for the variable follow
table(data$follow)
# Summarize: majority of people follow what is going on in government most of the time

#create a table for the variable dreamer
table(data$dreamer)
#Summarize: majority of people believe immigrants brought into the U.S illegally as a child should be allowed to stay and work in the U.S.

#create a table for the variable reg1a
table(data$reg1a)
#Summarize: majority of people are registered to vote